...
CREATE TABLE dish (
    ...
    category_id BIGINT NOT NULL,                         -- 菜品分类id
    price DECIMAL(10,2),                                 -- 菜品价格
    image VARCHAR(255),                                  -- 图片
    description VARCHAR(255),                             -- 描述信息
    status INT DEFAULT 1,                                 -- 0 停售 1 起售
    create_time TIMESTAMP,                                -- 创建时间
    update_time TIMESTAMP,                                -- 更新时间
    create_user BIGINT,                                   -- 创建人
    update_user BIGINT,                                   -- 修改人
    CONSTRAINT idx_dish_name UNIQUE (name)               -- 唯一索引
);
...
CREATE TABLE orders (
    ...
    delivery_status SMALLINT NOT NULL DEFAULT 1,           -- 配送状态 1立即送出 0选择具体时间
    delivery_time TIMESTAMP,                                 -- 送达时间
    pack_amount INT,                                         -- 打包费
    tableware_number INT,                                    -- 餐具数量
    tableware_status SMALLINT NOT NULL DEFAULT 1            -- 餐具数量状态 1按餐量提供 0选择具体数量
);
...
CREATE TABLE setmeal (
    ...
    status INT DEFAULT 1,                                  -- 售卖状态 0:停售 1:起售
    description VARCHAR(255),                               -- 描述信息
    image VARCHAR(255),                                     -- 图片
    create_time TIMESTAMP,                                  -- 创建时间
    update_time TIMESTAMP,                                  -- 更新时间
    create_user BIGINT,                                     -- 创建人
    update_user BIGINT,                                     -- 修改人
    CONSTRAINT idx_setmeal_name UNIQUE (name)              -- 唯一索引
);
